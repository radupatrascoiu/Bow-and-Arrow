...
void Laborator3_Vis2D::OnInputUpdate(float deltaTime, int mods)
{
	...
	logicSpace.y += (window->KeyHold(GLFW_KEY_W)) ? deltaTime * 12 : 0;
	logicSpace.x -= (window->KeyHold(GLFW_KEY_A)) ? deltaTime * 12 : 0;
	logicSpace.y -= (window->KeyHold(GLFW_KEY_S)) ? deltaTime * 12 : 0;
	logicSpace.x += (window->KeyHold(GLFW_KEY_D)) ? deltaTime * 12 : 0;

	logicSpace.width += (window->KeyHold(GLFW_KEY_Z)) ? deltaTime * 12 : 0;
	logicSpace.height += (window->KeyHold(GLFW_KEY_Z)) ? deltaTime * 12 : 0;
	logicSpace.x -= (window->KeyHold(GLFW_KEY_Z)) ? deltaTime * 6 : 0;
	logicSpace.y -= (window->KeyHold(GLFW_KEY_Z)) ? deltaTime * 6 : 0;

	logicSpace.width -= (window->KeyHold(GLFW_KEY_X)) ? deltaTime * 12 : 0;
	logicSpace.height -= (window->KeyHold(GLFW_KEY_X)) ? deltaTime * 12 : 0;
	logicSpace.x += (window->KeyHold(GLFW_KEY_X)) ? deltaTime * 6 : 0;
	logicSpace.y += (window->KeyHold(GLFW_KEY_X)) ? deltaTime * 6 : 0;
}
